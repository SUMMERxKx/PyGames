...
class Cube(object):
    ...
    def draw(self, surface, eyes=False):
        ...
        pygame.draw.circle(surface, self.color, (i * dis + dis // 2, j * dis + dis // 2), dis // 2 - 1)
        if eyes:
            radius = 3
            circleMiddle = (i * dis + dis // 2 - radius, j * dis + dis // 2 - radius)
            circleMiddle2 = (i * dis + dis // 2 + radius, j * dis + dis // 2 - radius)
...
class Snake(object):
    ...
    def draw(self, surface):
        for i, c in enumerate(self.body):
            c.draw(surface, True) if i == 0 else c.draw(surface)
